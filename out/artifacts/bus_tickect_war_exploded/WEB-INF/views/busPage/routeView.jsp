...
>
    ...
    <h1 style="text-align:center;color: blueviolet">Route View Page</h1>
<div class="container">
    <a href="/route/routecreate" class="btn btn-primary btn-sm">Create<i class="fa fa-plus"></i> </a><br>
    <table class="table">
        ...
        <c:forEach items="${route}" var="route">
            <tr>
                <td class="text-primary">${route.getRid()}</td>
                <td class="text-primary">${route.getStart()}</td>
                <td class="text-primary">${route.getEnd()}</td>
                <td><a href="/route/routeedit?rid=${route.getRid()}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> </a></td>
                <td><a href="/route/routedelete?rid=${route.getRid()}" class="btn btn-danger btn-sm" onclick="myfunction()"><i class="fa fa-trash"></i> </a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
