...
<div class="main_contents ">
    <div id="sub_content">
        <form action="/bus/buscreate" method="post">
            <h2 class="col-md-6 offset-md-2 mb-5 mt-4 text-info mr-4">Bus Registration</h2>

            <div class="row mb-4">
                <div class="col-md-2"></div>
                <label for="busName" class="col-md-2 col-form-label text-info text-info">Bus Name:</label>
                <div class="col-md-4">
                    <input type="text" class="form-control text-info" id="busName" name="busName" >
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                <button type="submit" class="btn btn-primary" value="create" onclick="myfunction()">Create</button>
            </div>
        </form>
    </div>
</div>
