...
x<%@ include file="/WEB-INF/views/public/header.jsp"%>
<%@ page import="app.daos.ScheduleDao" %>
<%@ page import="app.models.Schedule" %>
<%@ page import="java.util.Date" %>
<h1 style="text-align:center;color: blueviolet">Schedule Create Page</h1>
<%
...
>
    ...
    <form action="/schedule/update" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <div class="row mb-4">
                    ...
                    <label for="depatureTime" class="col-md-2 col-form-label text-info">Depature Time:</label>
                    <div class="col-md-4">
                        <input type="text" class="form-control" id="depatureTime" name="depatureTime" value="${schedule.getDepatureTime()}">
                    </div>
                </div>
        <div class="form-group">
        ...
        <button type="submit" class="btn btn-primary">NEXT Date</button>
            </div>
    </form>
